...
- [2026-03-06 PRD — Bill Runner Agent (Global)](2026-03-06-prd-bill-runner-agent-global.md)
- [2026-03-10 Cashflow algorithmic scenarios and logic flows](2026-03-10-cashflow-algorithmic-scenarios-and-logic-flows.md)
...
- [2026-03-10 Safety Shield working brief](2026-03-10-safety-shield-working-brief.md)
- [2026-03-10 Safety Shield detection scenarios and logic flows](2026-03-10-safety-shield-detection-scenarios-and-logic-flows.md)
...
- Just Pay PRD (WIP; see Payments Agents Hub in Confluence for latest link).
- Related workshop and prototype notes in `docs/meeting-notes/` and `docs/reference/`.
...
- [2026-03-10 Michael But approvals pod](2026-03-10-michael-but-approvals-pod.md)
- Bill approvals workflow PRDs and specs (see Payments Agents Hub).
