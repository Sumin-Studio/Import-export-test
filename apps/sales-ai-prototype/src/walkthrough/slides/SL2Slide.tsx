...
export default function SL2Slide() {
  const sl = swimlanes[1];
  const protos = prototypes.filter((p) => p.swimlane === "sl2");

  return (
    <SlideLayout slideNumber={10}>
      <div className="flex-1 max-w-5xl mx-auto px-8 py-16 w-full">
        <div className="mb-10">
          <div className="text-xs font-bold uppercase tracking-[0.15em] mb-2" style={{ color: sl.color }}>Swimlane 2</div>
