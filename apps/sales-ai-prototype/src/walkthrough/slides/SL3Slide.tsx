...
export default function SL3Slide() {
  const sl = swimlanes[2];
  const protos = prototypes.filter((p) => p.swimlane === "sl3");

  return (
    <SlideLayout slideNumber={11}>
      <div className="flex-1 max-w-5xl mx-auto px-8 py-16 w-full">
        <div className="mb-10">
          <div className="text-xs font-bold uppercase tracking-[0.15em] mb-2" style={{ color: sl.color }}>Swimlane 3</div>
