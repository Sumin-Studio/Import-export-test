          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                required
                autoFocus
                className="mx-auto block w-4/5 rounded-md border border-neutral-200 bg-white px-3 py-2 text-neutral-900 text-sm placeholder:text-neutral-400 focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/20"
