...
function CashflowShortfallChart({
  ...
  const options: Highcharts.Options = useMemo(() => {
    ...
    tooltip: {
      ...
      borderRadius: 12,
      shadow: false,
      /** Keep tooltips visually tied to the hovered point (especially Protect markers). */
        ...
        ? [
            {
              ...
              marker: {
                enabled: true,
                radius: purchasesV4SingleOrange ? 3.5 : 3,
                symbol: purchasesV4SingleOrange ? "circle" : "diamond",
                lineColor: "#FFFFFF",
                lineWidth: 1,
              },
              zIndex: 7,
