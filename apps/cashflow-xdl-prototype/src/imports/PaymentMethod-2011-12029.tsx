import svgPaths from "./svg-a5en99v26c";
import imgAvatar from "figma:asset/ddbc62e5b7754c1d8c06f674ac115af059a3b567.png";
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="main content">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center pr-[16px] py-[12px] relative w-full">
          <Headings2 />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.45] not-italic relative shrink-0 text-[#424f60] text-[13px] w-full">Bank of America account •••2742</p>
        </div>
      </div>
    </div>
  );
