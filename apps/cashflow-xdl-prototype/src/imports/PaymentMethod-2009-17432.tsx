import svgPaths from "./svg-pigw5kiat5";
    ...
    <div className="absolute h-[17.995px] left-[3px] top-[3px] w-[18px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 17.9953">
        <g id="Group 1321320797">
          <mask height="18" id="mask0_2008_17346" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="18" x="0" y="0">
            <path d={svgPaths.p1387800} fill="var(--fill-0, white)" id="Vector" />
          </mask>
          <g mask="url(#mask0_2008_17346)">
            <g id="Group 1321320798">
              <mask height="25" id="mask1_2008_17346" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="32" x="-10" y="-3">
                <path d={svgPaths.p24cc6c80} fill="var(--fill-0, #0C5CD0)" id="Rectangle 334" />
              </mask>
              <g mask="url(#mask1_2008_17346)">
                <path d={svgPaths.p24cc6c80} fill="var(--fill-0, #0C5CD0)" id="Rectangle 331" />
                <g filter="url(#filter0_f_2008_17346)" id="Ellipse 2">
                ...
                <g filter="url(#filter1_f_2008_17346)" id="Ellipse 6">
                ...
                <g filter="url(#filter2_f_2008_17346)" id="Ellipse 1">
                ...
                <g filter="url(#filter3_f_2008_17346)" id="Ellipse 5">
                ...
                <g filter="url(#filter4_f_2008_17346)" id="Ellipse 3">
                ...
                <g filter="url(#filter5_f_2008_17346)" id="Ellipse 4">
        ...
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="33.732" id="filter0_f_2008_17346" width="46.4172" x="-12.3809" y="-8.57259">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2008_17346" stdDeviation="3.11673" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="29.9004" id="filter1_f_2008_17346" width="28.1834" x="-12.7995" y="-10.7876">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2008_17346" stdDeviation="2.83787" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="29.9004" id="filter2_f_2008_17346" width="28.1834" x="-12.3952" y="-9.61217">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2008_17346" stdDeviation="2.83787" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="23.7569" id="filter3_f_2008_17346" width="38.0038" x="-26.3352" y="-13.9338">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2008_17346" stdDeviation="3.09585" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="25.674" id="filter4_f_2008_17346" width="26.9957" x="-5.36097" y="3.72797">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2008_17346" stdDeviation="3.09585" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="25.2239" id="filter5_f_2008_17346" width="26.7852" x="4.8807" y="3.26394">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2008_17346" stdDeviation="2.57988" />
          </filter>
        </defs>
      </svg>
    </div>
...
function Headings3() {
  return (
    <div className="relative shrink-0 w-full" data-name="headings">
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-[0px_12px] items-center leading-[0] not-italic pr-[12px] relative text-[#1e3145] text-[15px] w-full whitespace-nowrap">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center min-h-[24px] relative shrink-0">
            <p className="leading-[1.45]">ACH transfer</p>
          </div>
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center min-h-[24px] relative shrink-0">
            <p className="leading-[1.45]">Account •••7625</p>
          </div>
        </div>
      </div>
    </div>
