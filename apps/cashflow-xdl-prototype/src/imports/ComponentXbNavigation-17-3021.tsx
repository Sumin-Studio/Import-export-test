import { imgLogo, imgIcon, imgResizer, imgIcon1, imgIcon2, imgIcon3, imgIcon4, imgIcon5, imgIcon6, imgIcon7 } from "./svg-vvyxd";
...
function Menu() {
  return (
    <div className="bg-[#184390] box-border content-stretch flex gap-2.5 items-center justify-center px-3 py-2 relative rounded-[6px] shrink-0" data-name="Menu">
