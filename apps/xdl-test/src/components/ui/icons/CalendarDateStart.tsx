...
export default function CalendarDateEnd({
  ...
  return (
    ...
    >
      <path
        className={fill}
        d="M52 10H48V6C48 4.89539 47.1045 4 46 4C44.8955 4 44 4.89539 44 6V10H20V6C20 4.89539 19.1045 4 18 4C16.8955 4 16 4.89539 16 6V10H12C10.8955 10 10 10.8954 10 12V48C10 51.3137 12.6863 54 16 54H48C51.3137 54 54 51.3137 54 48V12C54 10.8954 53.1045 10 52 10ZM50 48C50 49.1046 49.1045 50 48 50H16C14.8955 50 14 49.1046 14 48V26H50V48ZM50 22H14V14H50V22ZM18 35.9999V31.9999C18 30.8954 18.8954 29.9999 20 29.9999H24C25.1045 29.9999 26 30.8954 26 31.9999V35.9999C26 37.1046 25.1045 37.9999 24 37.9999H20C18.8954 37.9999 18 37.1046 18 35.9999Z"
      />
    </svg>
  );
}
