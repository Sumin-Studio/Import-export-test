...
import { isInteractivePurchasesPrototype } from "@/app/lib/purchases-prototype-flags";
import {
...
export default function PurchasesOverview() {
  ...
  const interactiveEnabled = isInteractivePurchasesPrototype(pathname);
  ...
  const legacyOverviewHref =
    usePrototypeHref("/legacy") ?? "/purchases-overview/legacy";
  ...
  const iconButtonClass =
    "flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-lg border border-border-primary bg-white text-content-primary transition-colors hover:bg-[#eff1f2]";

  return (
    <PurchasesInteractiveLinkingContext.Provider value={linkingValue}>
      <div className="min-h-screen bg-[#e6e7e9]">
      <div className="mb-6 overflow-hidden bg-white py-[21px]">
        <div className="mx-auto flex max-w-full flex-col gap-3 px-4 sm:flex-row sm:items-center sm:justify-between md:px-5">
          <div className="flex flex-wrap items-center gap-3">
            <h1 className="text-[26px]/[30px]" style={{ fontFamily: "var(--font-national), 'National 2', sans-serif", fontWeight: 700 }}>Purchases overview</h1>
          </div>
          <div className="flex flex-wrap items-center gap-2 sm:justify-end">
            ...
            <button
              type="button"
              className="flex h-8 cursor-pointer items-center gap-2 rounded-lg border border-border-primary bg-white px-3 text-[13px]/[16px] font-bold text-content-primary transition-colors hover:bg-[#eff1f2]"
            >
              <Search className="shrink-0 text-content-primary" stroke="stroke-current" />
              Search
            </button>
            <Popover className="relative">
              <PopoverButton className="flex h-8 cursor-pointer items-center gap-2 rounded-lg border border-brand-primary bg-brand-primary px-3 text-[13px]/[16px] font-bold text-white outline-none transition-colors hover:border-[#0073BF] hover:bg-[#0073BF] data-[open]:border-[#0073BF] data-[open]:bg-[#0073BF]">
                Create
      ...
      <div className="mx-auto mb-4 w-full max-w-[448px] min-[1000px]:max-w-[908px] min-[1440px]:max-w-[1368px] min-[1900px]:max-w-[1828px]">
        <div className="rounded-xl bg-white px-4 py-[10px] sm:px-5">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            <div className="flex items-center gap-3 text-[14px]/[20px] text-content-primary sm:min-w-0 sm:flex-1">
            ...
            <div className="flex shrink-0 flex-wrap items-center gap-2 sm:justify-end">
              <Link
                ...
                className="mr-1 rounded-[48px] px-3 py-[6px] text-[13px]/[16px] font-[600] text-brand-primary transition-colors hover:bg-[#eff1f2]"
              >
                Switch to old
              </Link>
              <button
                type="button"
                className="rounded-[48px] border border-border-primary bg-white px-3 py-[6px] text-[13px]/[16px] font-[600] text-brand-primary transition-all duration-200 ease-in-out hover:bg-[#eff1f2]"
      ...
      <div className="container mx-auto mb-10 min-h-screen overflow-x-auto scroll-smooth lg:overflow-x-visible">
        <div className="mb-2 flex flex-wrap items-baseline gap-x-4 gap-y-2 lg:mb-4">
          <h2 className="text-[19px]/[32px] lg:text-[21px]/[32px]" style={{ fontFamily: "var(--font-national), 'National 2', sans-serif", fontWeight: 600 }}>Bills and payments</h2>
          <nav className="flex flex-wrap items-baseline gap-x-4 gap-y-1 text-[14px]/[20px]" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
            <Link href={billsHref} className="font-normal text-[#0165a8] hover:underline">
              Bills
            </Link>
            <a
              href="#"
              className="font-normal text-[#0165a8] hover:underline"
        ...
        {!hidePurchasesSupportingWidgets && <BillsStatusSummaryBanner />}
