...
export function PurchasesPrototypeSettingsButton() {
  ...
  const isPurchasesV4 = isPurchasesPrototypeV4OrLater(pathname);
        ...
        <div className="p-3">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-x-3 gap-y-2">
            <p className="max-w-[220px] text-[11px] font-bold uppercase leading-snug tracking-wider text-[#6b7280]">
              Bills status, widgets & purchase orders
            </p>
            <div
              className="flex shrink-0 rounded-full border border-[#e1e2e5] bg-white p-0.5 text-[11px]/[16px]"
              role="radiogroup"
              aria-label="Show or hide bills status, secondary widgets, and purchase orders section"
            >
              <button
                type="button"
                role="radio"
