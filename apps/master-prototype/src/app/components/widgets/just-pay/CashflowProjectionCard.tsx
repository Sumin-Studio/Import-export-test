...
const loadCashflowProjectionChart = () =>
  import(/* webpackMode: "eager" */ "../../charts/CashflowProjection");
...
export function CashflowProjectionCard({
  ...
  return (
    ...
    >
      ...
      {Chart ? (
        <Chart className="min-h-[300px] flex-1 px-3 pb-2 pt-0" />
      ) : (
        <div
