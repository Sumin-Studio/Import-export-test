...
const loadCashInAndOutChart = () =>
  import(/* webpackMode: "eager" */ "../charts/CashInAndOut");
  ...
  return (
    <CustomizationOverlay isCustomising={isCustomising}>
      ...
      >
        ...
        {Chart ? (
          <Chart className="px-[14px]" />
        ) : (
          <div className="px-[14px]" style={{ minHeight: 280 }} aria-hidden />
        )}
