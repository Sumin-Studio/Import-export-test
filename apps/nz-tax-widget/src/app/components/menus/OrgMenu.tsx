  ...
  return (
    <>
      {showBackButton ? (
        ...
        <div className="text-content-tertiary py-1 pr-3 pl-4">
          <h2 className="flex items-center text-[15px]/[24px] font-bold">
            <span className="flex size-8 flex-none items-center justify-center rounded-[3px] bg-[#9EEEFD] text-[13px]/[20px] font-bold text-[#154D58] uppercase">
              HE
            </span>
            <div className="p-2">Hornblower Enterprises</div>
          </h2>
        </div>
      )}
      <nav>
      ...
      <div className="relative mx-5 mb-3 flex items-center gap-3 rounded-md border border-[#A6A9B0] px-3 py-2 hover:border-[#80858F] has-[:focus]:ring-2 has-[:focus]:ring-[#81848d] has-[:focus]:ring-offset-[1px]">
        <svg
          className="flex-none"
          fill="none"
          height="18"
        ...
        <input
          className="placeholder-content-secondary w-full bg-transparent outline-none"
      ...
      <ul>
        <li>
          <button
            aria-disabled="true"
            className="text-content-primary hover:bg-background-tertiary flex w-full cursor-pointer items-center gap-3 px-5 py-2 text-left"
            type="button"
          >
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-[1.92px] bg-[#ADADF3] py-1 text-[11px]/[16px] font-bold text-[#202051] uppercase">
              FM
            </span>
            Fleetwood Motors
          </button>
        ...
        <li>
          <button
            ...
            type="button"
          >
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-[1.92px] bg-[#FDD580] py-1 text-[11px]/[16px] font-bold text-[#583C00] uppercase">
              LAR
            </span>
        ...
        <li>
          <button
            ...
            type="button"
          >
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-[1.92px] bg-[#9EEEFD] py-1 text-[11px]/[16px] font-bold text-[#154D58] uppercase">
              BB
            </span>
            Blue Breeze
          </button>
        ...
        <li>
          <button
            ...
            type="button"
          >
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-[1.92px] bg-[#FFB2CB] py-1 text-[11px]/[16px] font-bold text-[#592335] uppercase">
              MM
            </span>
            Makers Mugs
          </button>
      ...
      <ul>
        <li>
          ...
          >
            ...
            Demo Company{region !== "REST_OF_WORLD" ? ` (${region})` : ""}
          </button>
        </li>
        <li>
          <button
            aria-disabled="true"
            className="text-content-primary hover:bg-background-tertiary flex w-full items-center gap-3 px-5 py-2 text-left"
            type="button"
          >
            <span className="bg-content-primary/10 flex h-6 w-6 items-center justify-center rounded-[3px]">
              <svg
                fill="none"
                height="12"
                viewBox="0 0 12 12"
      ...
      <Disclosure as="div" defaultOpen={true}>
        <DisclosureButton className="group text-brand-secondary flex w-full cursor-pointer items-center justify-between px-5 py-2 text-[11px]/[20px] font-bold uppercase">
          Other Practices
        ...
        <DisclosurePanel>
          <ul>
            ...
            <li>
              <button
                aria-disabled="true"
                className="text-content-primary hover:bg-background-tertiary flex w-full items-center justify-between gap-3 px-5 py-2 text-left"
                type="button"
              >
                View all practices
