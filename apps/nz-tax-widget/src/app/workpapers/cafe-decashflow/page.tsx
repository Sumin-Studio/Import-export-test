...
import WorkpapersCafeDecashflowAUNZ from "@/app/assets/images/workpapers/aunz/workpapers-cafe-decashflow.svg";
import WorkpapersCafeDecashflowROW from "@/app/assets/images/workpapers/row/workpapers-cafe-decashflow.svg";
import WorkpapersCafeDecashflowUK from "@/app/assets/images/workpapers/uk/workpapers-cafe-decashflow.svg";
...
export default function CageDecashflowPage() {
  ...
  const getWorkpapersImage = () => {
    if (region === "AU" || region === "NZ") {
      return WorkpapersCafeDecashflowAUNZ;
    } else if (region === "USA") {
      return WorkpapersCafeDecashflowROW;
    } else if (region === "UK") {
      return WorkpapersCafeDecashflowUK;
    }
    return WorkpapersCafeDecashflowAUNZ; // default fallback
  };
  return (
    <div>
      <div className="">
          ...
          <div className="flex items-start justify-between">
            ...
            >
              ...
              <Link
                ...
                aria-selected="false"
                data-headlessui-state=""
                aria-controls="headlessui-tabs-panel-«r5s»"
      ...
      <div className="relative mb-10">
        <div className="absolute inset-x-0 h-[113px] border-b border-b-neutral-200 bg-white"></div>
        <div className="absolute inset-x-0 h-[76px] border-b border-b-neutral-200 bg-white"></div>
        <Image
